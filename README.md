...
This project focused on Cross-Modality Person Re-Identification (ReID) using RGB and Infrared (IR) images for surveillance and security applications. The goal was to develop a deep learning-based system capable of identifying the same person across different camera modalities (visible and infrared spectrum), especially under varying lighting conditions.
